...
- improved and fixed Browserslist query
  - our query used to include ancient Firefox versions that were never officially supported
- fixed some Eesti/Estonian i18n strings (again, thx Priit!)

### Changed

- updated dependencies
  - now powered by Astro 5.14
- set Crawl-Delay for MJ12bot
  - this doesn't do anything. It claims to respect robots.txt, but it doesn't
- rewrote styles in pure CSS
...
[Unreleased]: https://github.com/kytta/share2fedi/compare/v3.4.0...HEAD
[3.3.0]: https://github.com/kytta/share2fedi/compare/v3.3.0...v3.4.0
